...
(defun my/switch-project ()
  "Switch project with substring matching instead of fuzzy."
  (interactive)
...
(defun my/find-home ()
  ...
  (let ((default-directory "~/")
        (vertico-count 5)
        (consult-fd-args '((if (executable-find "fdfind") "fdfind" "fd")
                          "--color=never -H -d 4"
                          "-E .git -E .cache -E .local -E .cargo -E .Trash"
                          "-E .nix-defexpr -E .nix-profile -E .npm -E .nvm"
                          "-E .pyenv -E .conda -E .bun -E .docker -E .ollama"
                          "-E Library -E Applications -E Movies -E Music"
                          "-E Pictures -E Public -E Documents -E Downloads"
                          "-E node_modules -E elpa -E eln-cache -E go -E .vscode")))
    (consult-fd)))
