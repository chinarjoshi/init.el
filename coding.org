...
(use-package vterm
  ...
  (define-key vterm-mode-map (kbd "C-SPC") leader-map)
...
* Eglot
#+begin_src emacs-lisp
(setq project-vc-extra-root-markers '(".project" "go.mod" "Cargo.toml" "package.json" "pyproject.toml"))
...
(with-eval-after-load 'eglot
  (put 'eglot-error 'flymake-bitmap nil)
  (put 'eglot-warning 'flymake-bitmap nil)
  (put 'eglot-note 'flymake-bitmap nil))
