...
(setq scroll-conservatively my/scroll-conservatively)
...
(use-package consult
  ...
  (setq consult-async-refresh-delay my/consult-async-delay)
  (setq consult-async-input-debounce my/consult-async-debounce)
  (setq consult-async-input-throttle my/consult-async-throttle))
#+end_src
...
(use-package corfu
  ...
  :config
  (setq corfu-auto t)
  (setq corfu-auto-delay my/corfu-delay)
  (setq corfu-auto-prefix my/corfu-prefix)
  (global-corfu-mode 1)
